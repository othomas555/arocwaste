  ...
  async function createRun() {
    ...
    try {
      const payload = {
        ...
        route_slot: (createForm.route_slot || "ANY").toString().toUpperCase(),
  ...
  async function saveEdit() {
    ...
    try {
      const payload = {
        ...
        route_slot: (edit.route_slot || "ANY").toString().toUpperCase(),
    ...
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="mb-4 flex items-start justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-slate-600">
              Define today’s vans/crews by date + area + slot + vehicle + staff.
            </p>
          </div>
        ...
        {loading ? (
          ...
          <div className="space-y-2 pb-10">
            {runs.map((r) => {
              ...
              return (
                <div key={r.id} className="w-full rounded-2xl bg-white p-4 text-left shadow-sm ring-1 ring-slate-200">
      ...
      {drawerOpen ? (
        <div className="fixed inset-0 z-50">
          <button type="button" className="absolute inset-0 bg-black/30" onClick={() => setDrawerOpen(false)} aria-label="Close" />
          <div className="absolute inset-x-0 bottom-0 mx-auto max-w-5xl rounded-t-3xl bg-white p-4 shadow-2xl ring-1 ring-slate-200">
            ...
            {/* (rest of drawer unchanged from your version) */}
