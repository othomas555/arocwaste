...
export default function BookAppliancesPage() {
  ...
  function onContinue() {
    ...
    // Keep params consistent with furniture flow
    params.set("category", "appliances"); // safe to add; confirm already works for you
      ...
      <div className="mx-auto max-w-5xl px-4 py-10">
        {!item ? (
          <div className="rounded-2xl border bg-white p-6 shadow-sm">
            <h1 className="text-2xl font-semibold">Appliance item not found</h1>
          ...
          <>
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-2xl border bg-white p-6 shadow-sm">
                  <h3 className="text-lg font-semibold">Need a different item?</h3>
                  <p className="mt-2 text-sm text-gray-600">
                    Go back and choose a different appliance.
                  </p>
                  <div className="mt-4">
                    <Link
                      href="/appliances"
